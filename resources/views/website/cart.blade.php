                            ...
                            <tbody>
                                ...
                                <tr id="cart-item-{{ $item->id }}">
                                    <td class="cart-product-remove">
                                        <a href="javascript:void(0);" class="cart-product-remove text-danger"
                                            data-id="{{ $item->id }}">x</a>
                                    </td>
                                    ...
                                    <td class="cart-product-price" data-price="{{ $item->product->final_price }}">
                                        {{ number_format($item->product->final_price,2) }} ৳</td>
                                    <td class="cart-product-quantity">
                                        <div class="cart-plus-minus">
                                            <input type="number" value="{{ $item->quantity }}" name="qtybutton"
                                                class="cart-plus-minus-box" data-id="{{ $item->id }}" min="1">
                                        </div>
                                    </td>
                                    <td class="cart-product-subtotal" id="subtotal-{{ $item->id }}">
                                        {{ number_format($item->quantity * $item->product->final_price,2) }} ৳</td>
                                </tr>
                                @empty
                                <tr>
